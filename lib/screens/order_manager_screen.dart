...
//           _salesScrollController.position.maxScrollExtent) {
//         _loadMoreSales();
//       }
//     });
//
...
//           _purchasesScrollController.position.maxScrollExtent) {
//         _loadMorePurchases();
//       }
//     });
//
...
//         textColor = const Color(0xFF01BBFF);
//         text = 'Delivered';
//         break;
//       case 'DONE':
//         bgColor = Colors.green.withOpacity(0.2);
//         textColor = const Color(0xFF31D832);
//         text = 'Completed';
//         break;
//       case 'CONFIRMED':
...
//     final accountLabel = isSale ? 'Buyer' : 'Seller';
//
...
//                         Text(
//                           "$accountLabel: ${displayAccount?.name ?? 'Anonymous'}",
//                           style: const TextStyle(
//                             color: AppColors.textPrimary,
//                             fontSize: 13,
//                           ),
...
//                     const SizedBox(height: 4),
//                     Text(
//                       "Updated: ${order.formattedUpdatedAt}",
//                       style: const TextStyle(
//                         color: AppColors.textPrimary,
//                         fontSize: 12,
//                       ),
...
//             padding: const EdgeInsets.symmetric(horizontal: 16),
//             itemCount:
//             _salesOrders.length + (_isLoadingMoreSales ? 1 : 0),
...
//               vertical: 8,
//             ),
//             itemCount: _purchasesOrders.length +
//                 (_isLoadingMorePurchases ? 1 : 0),
//             itemBuilder: (context, index) {
...
//           tabs: const [
//             Tab(text: 'Created Orders'),
//             Tab(text: 'Purchased Orders'),
//           ],
//         ),
//       ),
//       body: TabBarView(
